...
func CreateOperatorRegistry(mgr manager.Manager, eventRecorder record.EventRecorder, expectationsStore *utils.ExpectationsStore) component.OperatorRegistry[v1alpha1.PodClique] {
