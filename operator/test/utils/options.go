...
// WithPCSGCurrentPGSGenerationHash sets the CurrentPodCliqueSetGenerationHash in the PCSG status.
...
// PGSOption is a function that modifies a PodCliqueSet for testing.
