...
const (
	...
	// LabelBasePodGang is a key for a label that sets the base PodGang name for individual PodGangs.
	// This label is present on individual PodGangs (beyond MinAvailable) and points to their base PodGang.
